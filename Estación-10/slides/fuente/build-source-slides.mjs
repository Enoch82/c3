...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Estación 10 - fuente HTML</title>
  <link rel="stylesheet" href="assets/deck.css">
</head>
<body>
<main class="deck">
...
writeFileSync(join(assetDir, "deck.css"), css);
writeFileSync(join(root, "estacion10-source-deck.html"), deck());
for (const slide of slides) {
  writeFileSync(join(slideDir, `slide-${slide.id}.html`), page(slide));
}

console.log(`Generated ${slides.length} source slide HTML files in ${root}`);
